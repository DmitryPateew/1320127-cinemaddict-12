...
import {StatisticPeriods, BAR_HEIGHT} from "../consant";
import {
  countWatchedFilms,
...
const createStatistic = (filmsDuration, watchedFilmsCount, rating, currentFilter, films, genre) => {
  return (`<section class="statistic">
    ...
    <form action="https://echo.htmlacademy.ru/" method="get" class="statistic__filters">
      ...
      <input type="radio" class="statistic__filters-input visually-hidden" name="statistic-filter" id="statistic-all-time" value="all-time" ${currentFilter === StatisticPeriods.ALL ? `checked` : ``}>
      <label for="statistic-all-time" class="statistic__filters-label">All time</label>

      <input type="radio" class="statistic__filters-input visually-hidden" name="statistic-filter" id="statistic-today" value="today" ${currentFilter === StatisticPeriods.TODAY ? `checked` : ``}>
      <label for="statistic-today" class="statistic__filters-label">Today</label>

      <input type="radio" class="statistic__filters-input visually-hidden" name="statistic-filter" id="statistic-week" value="week" ${currentFilter === StatisticPeriods.WEEK ? `checked` : ``}>
      <label for="statistic-week" class="statistic__filters-label">Week</label>

      <input type="radio" class="statistic__filters-input visually-hidden" name="statistic-filter" id="statistic-month" value="month" ${currentFilter === StatisticPeriods.MONTH ? `checked` : ``}>
      <label for="statistic-month" class="statistic__filters-label">Month</label>

      <input type="radio" class="statistic__filters-input visually-hidden" name="statistic-filter" id="statistic-year" value="year" ${currentFilter === StatisticPeriods.YEAR ? `checked` : ``}>
...
export default class StatisticView extends AbstractView {
  ...
  _getTemplate() {
    ...
    return createStatistic(filmsDuration, watchedFilmsCount, rating, this._currentFilter, this._films, this._topGenre);
  }
}
